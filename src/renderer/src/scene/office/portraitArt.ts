// Procedural portraits for the Studio Floor starter roster.
//
...
const RECIPES: Record<OfficeCharacterName, Recipe> = {
  ...
  bjorn: { skin: 'light', hairc: [120, 100, 78], hair: 'styleMessy', hairargs: { length: 12 }, cloth: 'polo', c1: [48, 76, 96], c2: [38, 58, 72], brow: 'soft', mouth: 'smile' },
  mike: { skin: 'light', hairc: [52, 58, 68], hair: 'styleShort', hairargs: { part: 'R' }, cloth: 'suit', c1: [28, 46, 82], c2: [52, 126, 190], tie: [48, 126, 190], brow: 'flat', mouth: 'smile' },
  andrew: { skin: 'light', hairc: [78, 64, 54], hair: 'styleShort', hairargs: { part: 'L', recede: 1 }, cloth: 'suit', c1: [38, 46, 66], c2: [182, 198, 220], tie: [210, 210, 190], glasses: true, brow: 'soft', mouth: 'smile' },
  rob: { skin: 'light', hairc: [80, 70, 62], hair: 'styleBald', cloth: 'suit', c1: [28, 28, 34], c2: [58, 58, 68], tie: [22, 22, 24], brow: 'flat', mouth: 'neutral' },
  claudia: { skin: 'light', hairc: [188, 150, 100], hair: 'styleFrame', hairargs: { length: 21, vol: 1 }, cloth: 'blouse', c1: [30, 30, 34], brow: 'soft', mouth: 'smile', lashes: true },
  ...
  studio04: { skin: 'light', hairc: [64, 48, 28], hair: 'styleShort', hairargs: { part: 'L', recede: 1 }, cloth: 'dressshirt', c1: [184, 155, 62], tie: [120, 82, 46], glasses: true, brow: 'angry', mouth: 'neutral' },
  studio05: { skin: 'light', hairc: [58, 44, 30], hair: 'styleBald', cloth: 'polo', c1: [110, 140, 180], c2: [90, 120, 160], brow: 'flat', mouth: 'neutral', heavy: true },
  studio06: { skin: 'light', hairc: [186, 154, 90], hair: 'styleBun', cloth: 'cardigan', c1: [150, 146, 170], c2: [235, 233, 226], brow: 'angry', mouth: 'frown', lashes: true },
  studio07: { skin: 'tan', hairc: [28, 22, 18], hair: 'styleShort', hairargs: { part: 'L' }, cloth: 'sweater', c1: [122, 60, 74], brow: 'flat', mouth: 'smile' },
  studio08: { skin: 'dark', hairc: [60, 54, 48], hair: 'styleRecede', cloth: 'dressshirt', c1: [150, 120, 86], tie: [120, 78, 52], glasses: true, facial: 'mustache', brow: 'flat', mouth: 'neutral', heavy: true },
  studio09: { skin: 'light', hairc: [196, 162, 110], hair: 'styleCurly', cloth: 'blouse', c1: [202, 160, 192], glasses: true, brow: 'soft', mouth: 'smile', lashes: true, heavy: true },
  studio10: { skin: 'light', hairc: [74, 51, 32], hair: 'styleShort', hairargs: { part: 'R' }, cloth: 'polo', c1: [176, 65, 58], c2: [150, 50, 46], brow: 'raised', mouth: 'smile' },
  studio11: { skin: 'tan', hairc: [24, 18, 22], hair: 'styleFrame', hairargs: { length: 20, vol: 1 }, cloth: 'blouse', c1: [212, 90, 158], brow: 'soft', mouth: 'smile', blush: true, lashes: true },
  studio12: { skin: 'light', hairc: [42, 32, 24], hair: 'styleSpiky', cloth: 'suit', c1: [58, 58, 68], tie: [40, 40, 50], brow: 'flat', mouth: 'neutral' },
  studio13: { skin: 'light', hairc: [106, 90, 66], hair: 'styleShort', hairargs: { part: 'L', recede: 1 }, cloth: 'dressshirt', c1: [150, 150, 120], facial: 'mustacheSm', brow: 'soft', mouth: 'frown' },
  studio14: { skin: 'light', hairc: [170, 166, 156], hair: 'styleBald', cloth: 'dressshirt', c1: [126, 130, 96], facial: 'stubble', brow: 'flat', mouth: 'neutral' },
  studio15: { skin: 'light', hairc: [154, 82, 46], hair: 'styleMessy', hairargs: { length: 15 }, cloth: 'blouse', c1: [176, 86, 74], brow: 'raised', mouth: 'smile', lashes: true },
};
...
function getBuf(name: OfficeCharacterName): Buf {
  ...
  if (!buf) {
    buf = compose(RECIPES[name] ?? RECIPES.studio02);
...
export function sceneFrameBufs(name: OfficeCharacterName): SceneFrames {
  ...
  if (!frames) {
    const r = RECIPES[name] ?? RECIPES.studio02;
    frames = {
